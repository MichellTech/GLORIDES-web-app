        ...
        <div className='max-w-md sm:max-w-2xl mx-auto font-sans md:max-w-5xl lg:max-w-6xl xl:max-w-7xl  px-4 md:px-6  lg:px-8 space-y-6 lg:space-y-10   pb-10 '>
          ...
          <div className='flex justify-between items-center gap-2'>
            ...
            <div className='flex items-center gap-2 sm:gap-3 md:gap-6'>
              <button className='px-2 sm:px-4 lg:px-6  py-2 lg:py-3  rounded-md border border-indigo-500 text-xs md:text-sm xl:text-base  hover:bg-indigo-500 hover:text-white hover:duration-500  shadow-md hover:shadow-xl'>
                Edit Car Details
              </button>
              <button className='px-2 sm:px-4 lg:px-6  py-2 lg:py-3 rounded-md border border-babypurple text-xs md:text-sm xl:text-base hover:bg-babypurple hover:text-white hover:duration-500  shadow-md hover:shadow-xl'>
                Delist Vehicle
              </button>
            </div>
          </div>
