  ...
  return (
    <>
      ...
      <div className='md:flex  w-full'>
        {/* image */}
        <div className="md:bg-[url('/images/fpassword.png')] bg-no-repeat bg-top bg-cover hidden  md:w-1/2 lg:w-2/5 h-[100v] bg-none py-6 px-6 lg:px-10 xl:px-16 md:flex flex-col justify-center">
          {/* logo */}
          <Link href='/'>
        ...
        <div className=' md:w-1/2 lg:w-3/5'>
          <div className="bg-[url('/images/fpassword.png')] bg-no-repeat bg-top bg-cover w-full h-full md:bg-none">
            {/* content */}
            <div className='flex flex-col justify-center items-start min-h-screen md:max-w-xs lg:max-w-sm  xl:max-w-md mx-auto   space-y-10 md:space-y-0 py-10 md:py-2'>
              ...
              <div className='space-y-2 md:space-y-3 hidden md:block'>
                ...
                <p className='text-xs md:text-sm text-center font-babyblack  mx-auto lg:text-base md:text-left md:mx-auto '>
                  Please provide your login email details linked to your account
                  on our platform
                </p>
              </div>
              {/*form */}
              ...
              {/* link to signup */}
              <h1 className='text-center  text-xs  text-white  md:text-babyblack mx-auto'>
                Didn't get the code ?{' '}
