...
function savedvehicles() {
  const { bookmarked, isLoading } = useSelector((store) => store.rental)
          ...
          {bookmarked?.length < 1 ? (
            <div className='flex justify-center items-center flex-col space-y-2 xl:space-y-3'>
              ...
              <p className='text-xs md:text-sm xl:text-base max-w-xs lg:max-w-lg text-center'>
                ...
                bookmarked any car. Bookmark a vehicle today to easily access
                them when next you wan to rent a car
              </p>
            </div>
          ) : (
                      ...
                      <div className='px-4 w-full '>
                        ...
                        <div className='pt-6 space-y-4'>
                          ...
                          {item?.status === 'listed' ? (
                            ...
                            <button className='bg-softRed px-2 py-2  w-full text-xs text-white  cursor-pointer hover:shadow-lg font-bold tracking-widest lg:text-sm rounded-md'>
                              in-service
                            </button>
                          )}
                        </div>
