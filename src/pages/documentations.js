            ...
            {pannel === '1' ? (
              <div className=' space-y-6  md:space-y-8 xl:space-y-10'>
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    Upperlink Digital Solutions Limited (“Upperlink”, the
                    “Company”, or “we” or “us”) values your Personal Data and we
                    are committed to protecting your privacy whenever you
                    interact with us through PayGuy services which include all
                    pages within the PayGuy website, mobile applications and
                    other products and services (collectively referred to as the
                    “PayGuy Service Channels”, PayGuy Services” or “Services”).
                    Please read this Privacy Policy (the “Policy”) to understand
                    our policies, processes, and procedures regarding the
                    processing of your personal data. By this Policy, we explain
                    to you how your Personal Data is collected, used, managed,
                    transferred and or deleted on the PayGuy Service Channels
                    and also explain how you can update your Personal Data with
                    us and exercise your rights in respect of your Personal Data
                    provided to us.{' '}
                  </p>
                </div>
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    To access the PayGuy Services and for optimal use of the
                    ...
                    users with access to the PayGuy Services. By visiting the
                    PayGuy Service Channels and using the PayGuy Services, you
                ...
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    ...
                    <li>
                      customize and improve the layout of the PayGuy Service
                      Channels;
                    </li>
                    <li>
                ...
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    ...
                    processing of your Personal Data when you access our PayGuy
                    Service Channels, or use our services, content, features,
                    technologies, or functions offered on the PayGuy Service
                    ...
                    communication. Once you begin using our PayGuy Services
                    Channels, we will keep records of your transactions and
                    collect information of your other activities related to our
                    PayGuy services. We will not share or disclose your Personal
                    Information with a third party without your consent. We will
                    not use your information or seek your consent to use your
                    information for the propagation of atrocities, hate, child
                    rights violation, criminal acts and anti-social conducts.
                  </p>
                </div>
                ...
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    ...
                    your Personal Data with billers on the PayGuy Service
                    Channels or service providers engaged by us to provide
                    services to PayGuy, subject to appropriate data security and
                    protection. In addition, we may transfer your Personal Data
                    out of Nigeria in line with the requirements of the Nigeria
                    Data Protection Regulation, 2019. We shall also share your
                    Personal Data with third parties directly authorized by you
                    to receive Personal Information, such as when you authorize
                    a third-party service provider to access your account. The
                    use of your personal information by an authorized third
                    party shall be subject to the privacy policy of the
                    third-party and we shall not bear any liability for any
                    breach which might arise due to your authorization. We shall
                    also share your Personal Information if it is believed that
                    such sharing is required to satisfy any applicable laws,
                    regulation or government request. PayGuy may contain
                    third-party links or links to other websites. Please be
                    advised that we are not responsible for the privacy
                    practices or contents of these sites and shall not be
                    responsible for your use of such websites. We encourage you
                    to be aware of when you leave PayGuy Service Channels and to
                    read the privacy statements of these sites. You should
                    evaluate the security and trustworthiness of any other site
                    connected to PayGuy Service Channels or accessed through
                    PayGuy Service Channels, before disclosing any personal
                    information to them. We will not accept any responsibility
                    for any loss or damage in whatever manner resulting from
                    your disclosure of your personal information to third
                    parties. However, we shall also make all reasonable efforts
                    to ensure that adequate safeguards have been put in place to
                    prevent unauthorized access and to ensure confidentiality of
              ...
              <div className=' space-y-6  md:space-y-8 xl:space-y-10'>
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    Upperlink Digital Solutions Limited (Upperlink, “we”, “our”
                    or “us”) may use cookies, web beacons, tracking pixels, and
                    other tracking technologies when you use PayGuy services
                    which include all pages within the PayGuy web services,
                    mobile applications and other products and services
                    (collectively referred to as “PayGuy Service Channels”,
                    “PayGuy Services” or “Services") to help customize the
                    PayGuy Services and improve your experience. <br /> <br />
                    ...
                    immediately upon posting the updated Cookie Policy on PayGuy
                    Service Channels, and you waive the right to receive
                    ...
                    Policy by your continued use of PayGuy after the date such
                ...
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    ...
                    time you submit a query on PayGuy Service Channels. We use
                    cookies on the PayGuy Service Channels to, among other
                    things, keep track of services you have used, record
                    registration information, record your user preferences, keep
                    you logged into the PayGuy Service Channels, facilitate
                    purchase procedures, and track the pages you visit. Cookies
                    help us understand how the PayGuy Service Channels are being
                    used and improve your user experience
                  </p>
                </div>
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  <h1 className='font-bold text-xl md:text-2xl xl:text-3xl'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    ...
                    <li>
                      ...
                      gather information about your visits to the PayGuy Service
                      Channels, alternate the ads sent to a specific computer,
                    ...
                    <li>
                      ...
                      Analytics Cookies monitors how users reached the PayGuy
                      Service Channels, and how they interact with and move
                      around once on the PayGuy Service Channels. These cookies
                      let us know what features on the PayGuy Service Channels
                      are working the best and what features on the PayGuy
                    ...
                    <li>
                      ...
                      without which the PayGuy Service Channels won't work
                    ...
                    <li>
                      ...
                      or session on the PayGuy Service Channels so that you are
                    ...
                    <li>
                      ...
                      you visit the PayGuy Service Channels by billers and
                      service providers on PayGuy Service Channels. These
                ...
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    ...
                    availability and functionality of the PayGuy Service
                    Channels.
                  </p>
                </div>
                ...
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    ...
                    and other tracking technologies on the PayGuy Service
              ...
              <div className=' space-y-6  md:space-y-8 xl:space-y-10'>
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base '>
                    ...
                    Upperlink Digital Solutions Limited including its agents,
                    assigns and successors in title (Upperlink, “we”, “our” or
                    “us”) with respect to its PayGuy services and shall govern
                    your access to and use of all pages within the PayGuy
                    website, mobile applications and other products and services
                    (collectively referred to as the “PayGuy Services Channels”,
                    “PayGuy Services” or “Services”).
                ...
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    You may use the PayGuy Services only if you agree to form a
                    binding contract with Upperlink and are not a person barred
                ...
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    Unless otherwise stated, Upperlink and/or its licensors own
                    the intellectual property rights and materials with respect
                    to the PayGuy Service Channels subject to the license below.
                    All text, formatting (including without limitation the
                    arrangement of materials on the PayGuy Service Channels and
                    the graphics, animation, tools, commercials, music, video,
                    articles, sound, copy, trade names, logos, and other
                    materials and information on the PayGuy Service Channels are
                    subject to the intellectual property rights of Upperlink and
                    ...
                    websites. Nothing on the PayGuy Service Channels should be
                    construed as granting by implication or otherwise, any
                    license or right to use any Trademark displayed on the
                    PayGuy Service Channels without the written permission of
                    Upperlink or such third party that may own the Trademark.
                    You agree to take such actions that may be needed to further
                    affirm our intellectual property rights.
                  </p>
                </div>
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  <h1 className='font-bold text-xl md:text-2xl xl:text-3xl'>
                    License to Use the PayGuy Service Channels
                  </h1>
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    ...
                    PayGuy name or any of PayGuy trademarks, logos, domain
                    names, and other distinctive brand features. All right,
                    titles, and interests in and to the services are and will
                    remain the exclusive property of Upperlink and its
                    licensors. If you do not comply with all the provisions,
                    then you will be liable for all resulting damages suffered
                    by you, Upperlink, and all third parties. Unless otherwise
                    ...
                    create any source code that is derived from the PayGuy
                ...
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base text-transform: lowercase first-letter:uppercase'>
                    {' '}
                    UPPERLINK WILL ALWAYS ENSURE THAT THE PAYGUY SERVICE
                    CHANNELS ARE AVAILABLE AT ALL TIMES AND BUG-FREE. HOWEVER,
                    THEY ARE USED AT YOUR OWN RISK. WE PROVIDE ALL MATERIALS “AS
                    IS” WITH NO WARRANTY, EXPRESS OR IMPLIED, OF ANY KIND. WE
                    EXPRESSLY DISCLAIM ANY AND ALL WARRANTIES AND CONDITIONS,
                    INCLUDING ANY IMPLIED WARRANTY OR CONDITION OF
                    MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE,
                    AVAILABILITY, SECURITY, TITLE, AND NON-INFRINGEMENT OF
                    INTELLECTUAL PROPERTY RIGHTS, WITHOUT LIMITING THE
                    GENERALITY OF THE FOREGOING. WE MAKE NO WARRANTY THAT OUR
                    SERVICES WILL MEET YOUR REQUIREMENTS OR THAT THE PAYGUY
                    SERVICE CHANNELS WILL REMAIN FREE FROM ANY INTERRUPTION,
                    BUGS, INACCURACIES, AND ERROR-FREE. YOUR USE OF OUR SERVICES
                    IS AT YOUR OWN RISK AND YOU ALONE WILL BE RESPONSIBLE FOR
                    ANY DAMAGE THAT RESULTS IN LOSS OF DATA OR DAMAGE TO YOUR
                    COMPUTER SYSTEM. NO ADVICE OR INFORMATION, WHETHER ORAL OR
                    WRITTEN OBTAINED BY YOU FROM PAYGUY SERVICE CHANNELS WILL
                ...
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    When you initiate and confirm a transaction on PayGuy
                    ...
                    <br />
                    Our PayGuy service is designed to make payments convenient,
                    ...
                    <li>
                      ...
                      perform transactions on PayGuy;
                    </li>
                    <br />
                ...
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    When making a payment to a Biller on PayGuy Service
                    ...
                    you choose to secure your use of (and access to) PayGuy
                    services.
                    <br />
                    <br />
                ...
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    When signing up for a PayGuy account, you will be prompted
                ...
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    ...
                    of the PayGuy transaction. You agree to indemnify and hold
                ...
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    ...
                    <li>
                      ...
                      consecutive occasions, we will lock your access to PayGuy
                ...
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base text-transform: lowercase first-letter:uppercase'>
                    YOUR USE OF THE PAYGUY SERVICE CHANNELS IS AT YOUR OWN RISK.
                    UPPERLINK WILL IN NO WAY BE LIABLE FOR ANY DIRECT, INDIRECT,
                    INCIDENTAL PUNITIVE, CONSEQUENTIAL, SPECIAL, OR EXEMPLARY
                    DAMAGES OR ANY DAMAGES INCLUDING DAMAGES RESULTING FROM
                    REVENUE LOSS, PROFIT LOSS, USE, DATA, GOODWILL, BUSINESS
                    INTERRUPTION, OR ANY OTHER INTANGIBLE LOSSES (WHETHER
                    UPPERLINK HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH
                    DAMAGES OR NOT) ARISING OUT OF YOUR USE OF THE PAYGUY
                    SERVICE CHANNELS OR SERVICES (INCLUDING, WITHOUT LIMITATION
                    TO YOUR INABILITY TO USE, OR ARISING FROM THE RESULT OF USE
                    OF PAYGUY SERVICE CHANNELS OR SERVICES) WHETHER SUCH DAMAGES
                ...
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    You hereby indemnify Upperlink and undertake to keep
                    ...
                    Upperlink harmless from and against any claim, suit, or
                    proceedings brought against Upperlink arising from or in
                ...
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    ...
                    Terms, if you breach these Terms in any way, Upperlink may
                    take such action as Upperlink deems appropriate to deal with
                    the breach, including suspending your access to the PayGuy
                    service Channels, prohibiting you from accessing PayGuy
                ...
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    Upperlink recognizes the importance of protecting the
                    privacy of those who visit the PayGuy Service Channels and
                    choose to use the PayGuy Services. With respect to all the
                    Personal Information belonging to, and/or processed in
                    connection with PayGuy Services, such Personal Information
                    ...
                    data protection regulation in force. Upperlink maintains a
                    ...
                    the PayGuy Services you consent to such processing and you
                ...
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    ...
                    between Upperlink and you will be the English language.
                  </p>
                </div>
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  <h1 className='font-bold text-xl md:text-2xl xl:text-3xl'>
                ...
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    Upperlink reserves the right to change, revise or modify
                ...
                <div className=' space-y-3  md:space-y-4 xl:space-y-5'>
                  ...
                  <p className='text-xs text-justify leading-5 md:leading-6 xl:leading-7 md:text-sm xl:text-base'>
                    ...
                    agreements between you and Upperlink whether written or
                    oral, relating to its subject matter. In the event that any
                    of these Terms is held to be invalid or unenforceable, then
                    that provision will be limited or eliminated to the minimum
                    extent necessary, and the remaining provisions of these
                    Terms will remain in full effect. Upperlink ’s failure to
