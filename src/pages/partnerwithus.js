...
function partnerwithus() {
  ...
  return (
    <>
      <Navbar />
      {/* hero */}
      <div className=' mt-8 mb-16 xl:my-10 max-w-xs sm:max-w-md mx-auto font-sans md:max-w-4xl lg:max-w-5xl xl:max-w-7xl  px-4 md:px-6  lg:px-8 overflow-x-hidden'>
        {/* container */}
